...
C <- c(0.01, seq(0.1, 1.5, 0.1), 2, 5, 10)
sigma <- c(0.01, seq(0.1, 1.5, 0.1), 2, 5, 10)

grid_linear <- expand.grid(C = C)
grid_poly <- expand.grid(degree = 2:6, scale = 1, C = C)
grid_radial <- expand.grid(sigma = sigma, C = C)
grid_tree <- expand.grid(maxdepth = 2:30)
